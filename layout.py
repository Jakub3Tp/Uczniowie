...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.delete_2, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.failStudents, 4, 1, 1, 2)
...
"color: #FF0000")
        ...
        self.gridLayout.addWidget(self.judgement, 5, 0, 1, 3)
        self.name = QtWidgets.QLineEdit(parent=self.gridLayoutWidget)
        self.name.setMaximumSize(QtCore.QSize(23333, 10222))
        self.name.setObjectName("name")
        self.gridLayout.addWidget(self.name, 1, 1, 1, 1)
        self.studentsCombo = QtWidgets.QComboBox(parent=self.gridLayoutWidget)
        self.studentsCombo.setObjectName("studentsCombo")
        self.gridLayout.addWidget(self.studentsCombo, 1, 2, 2, 1)
